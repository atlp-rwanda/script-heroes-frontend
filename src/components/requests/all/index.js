...
class Trips extends Component {
  ...
  render() {
    ...
    const showTable = isLoading || error != null || !trips.length ? "none" : "";
    const noRequests =
      !isLoading && !trips.length && error == null ? (
        <Alert color="danger">No requests to show</Alert>
      ) : null;
